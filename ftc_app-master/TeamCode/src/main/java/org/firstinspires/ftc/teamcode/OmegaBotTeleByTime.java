...
@TeleOp(name="OmegaBotTeleByTime", group="VelocityVortex")
//@Disabled
public class OmegaBotTeleByTime extends OpMode {
    ...
    public boolean readyToShoot = false; //Nidhir wrote this "lock" mechanic, so shouldn't he be responsible for motors burning out?
    ...
    public void loop() {
      ...
      /*  if (!gamepad2.a) {
        ...
        if (gamepad2.a) {
            ...
            runtime.reset();
            while ((runtime.seconds() < 0.06631944445) && (!readyToShoot)) {
                fling.setPower(0.5);
                loadPos += fling.getCurrentPosition();
                telemetry.addData("Load Position", loadPos);
            }
